...
export const metadata = {
  ...
  description:
    "Read our latest blog posts about custom cakes, baking tips, event stories, cake recipes, and behind-the-scenes from Cocoa&Cherry FSSAI certified bakery in Ahmedabad. Learn about cake decoration, delivery tips, and more!",
  keywords: [
    "cake blog ahmedabad",
    "baking tips",
    "cake recipes",
  ...
  openGraph: {
    ...
    description:
      "Read our latest blog posts about custom cakes, baking tips, event stories, and behind-the-scenes from Cocoa&Cherry FSSAI certified bakery in Ahmedabad.",
    images: [
      {
  ...
  twitter: {
    ...
    description:
      "Read our latest blog posts about custom cakes, baking tips, and bakery stories from Ahmedabad.",
  ...
  "@graph": [
    {
      ...
      description:
        "Read our latest blog posts about custom cakes, baking tips, event stories, cake recipes, and behind-the-scenes from Cocoa&Cherry FSSAI certified bakery in Ahmedabad.",
      inLanguage: "en-IN",
      isPartOf: {
        "@id": `${siteUrl}/#website`,
      },
    ...
    },
    {
      ...
      description:
        "Cake stories, baking tips, recipes, and behind-the-scenes content from Cocoa&Cherry bakery in Ahmedabad",
      url: `${siteUrl}/blog`,
      publisher: {
