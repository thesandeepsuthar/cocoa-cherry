...
export default function Order() {
  ...
  useEffect(() => {
    ...
    return () =>
      window.removeEventListener("selectCakeForOrder", handleCakeSelection);
  }, [menuItems]);
  ...
  const updateCakeQuantityUnit = (cakeName, unit) => {
    setSelectedCakes((prev) =>
      prev.map((cake) =>
        cake.name === cakeName ? { ...cake, quantityUnit: unit } : cake,
      ),
    );
  };
...
Sent from Cocoa&Cherry Website`;
  ...
  const getInputClass = (fieldName) => {
    const baseClass =
      "w-full bg-noir border rounded-lg sm:rounded-xl px-3 sm:px-4 py-2.5 sm:py-3 text-sm sm:text-base text-cream placeholder-cream-muted/50 transition-all duration-300";
    const focusClass =
              ...
              <div className="relative h-full flex flex-col justify-end p-5 sm:p-6 md:p-10">
                ...
                >
                  ...
                  <p className="text-cream/80 text-sm sm:text-base md:text-lg mb-4 sm:mb-6">
                    Select your favorite cakes and fill out the form to start
                    your order!
                  </p>
            ...
            >
              <div className="mb-5 sm:mb-6 md:mb-8">
                ...
                <div className="flex items-start gap-2 p-2.5 sm:p-3 rounded-lg bg-gold/10 border border-gold/20">
                  <span className="material-symbols-outlined text-gold text-sm sm:text-base mt-0.5">
                    info
                  </span>
                  <p className="text-gold/90 text-[11px] sm:text-xs leading-relaxed">
                    <strong>Note:</strong> Prices, quantity (kg/piece/box), and
                    customization details will be discussed on WhatsApp.
                  </p>
                </div>
              </div>
              ...
              >
                ...
                >
                  ...
                  <div
                    className={`min-h-[60px] p-3 rounded-xl border transition-all ${
                      focusedField === "cakes"
                          ...
                          {selectedCakes.map((cake) => (
                            ...
                            >
                              <div className="flex items-center gap-2">
                                ...
                                <span className="text-cream text-sm font-medium flex-1">
                                  {cake.name}
                                </span>
                                <button
                                  type="button"
                              ...
                              <div className="flex items-center gap-2 pl-7">
                                <button
                                  ...
                                  onClick={() =>
                                    updateCakeQuantity(
                                      cake.name,
                                      Math.max(0.5, (cake.quantity || 1) - 0.5),
                                    )
                                  }
                              ...
                              {menuItems
                                ...
                                .map((item) => (
                                  ...
                                  >
                                    ...
                                    <p className="flex-1 text-cream text-sm font-medium truncate">
                                      {item.name}
                                    </p>
                                    <span className="material-symbols-outlined text-cream/30 text-sm">
                                      add_circle
                                    </span>
                                  </button>
                                ))}
                  ...
                  {isSubmitting ? (
                    ...
                    <>
                      <span className="relative">
                        Send {selectedCakes.length} Item
                        {selectedCakes.length > 1 ? "s" : ""} to WhatsApp
                      </span>
                      <span className="material-symbols-outlined text-base relative">
                        send
                      </span>
                    </>
                  )}
