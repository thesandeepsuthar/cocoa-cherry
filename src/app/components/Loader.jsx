...
export function LogoSVG({ size = 80, className = '' }) {
  return (
    ...
    >
      ...
      <line x1="136" y1="72" x2="172" y2="72" stroke="#c9a86c" strokeWidth="2"/>
      
      {/* Text Box Frame */}
      <rect x="32" y="108" width="136" height="40" fill="none" stroke="#c9a86c" strokeWidth="2"/>
      
      {/* Brand Name Text */}
      <text x="100" y="134" textAnchor="middle" fontFamily="Georgia, 'Times New Roman', serif" fontSize="22" fontWeight="500" fill="#c9a86c">Cocoa&amp;cherry</text>
      
      {/* Bottom decorative line */}
      <line x1="28" y1="158" x2="172" y2="158" stroke="#c9a86c" strokeWidth="2"/>
    </svg>
  );
}
