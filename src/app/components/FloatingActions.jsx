...
export default function FloatingActions() {
  ...
  const openWhatsApp = () => {
    const message = encodeURIComponent(
      "Hi! I'm interested in ordering a cake from Cocoa&Cherry 🎂",
    );
      ...
      <div className="fixed bottom-4 right-4 md:bottom-6 md:right-6 z-50 flex flex-col items-end gap-3 md:gap-4">
        ...
        >
              ...
              >
                <div className="relative bg-noir-light border border-[#25D366]/30 rounded-2xl shadow-2xl p-4 min-w-[200px]">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <div>
                      <p className="text-[#c9a86c] font-bold text-sm">
                        Cocoa&Cherry
                      </p>
                  ...
                  <p className="text-cream-muted text-xs mb-3">
                    Hi! 👋 Ready to order your dream cake? We typically reply
                    within minutes!
                  </p>
                  <motion.button
          ...
          <motion.span
            ...
            style={{
              background:
                "conic-gradient(from 0deg, transparent, #25D366, transparent)",
            }}
            animate={{ rotate: 360 }}
