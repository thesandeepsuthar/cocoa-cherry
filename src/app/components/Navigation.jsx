            ...
            >
              <div className="flex flex-col items-center justify-center gap-1 md:gap-1.5">
                ...
                <motion.span
                  ...
                  className="w-4 md:w-5 h-0.5 bg-cream rounded-full"
                />
                <motion.span
                  animate={{
                    rotate: isOpen ? -45 : 0,
        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-0 right-0 bottom-0 z-50 w-72 md:w-80 max-w-[85vw] bg-noir-light border-l border-rose/20 lg:hidden overflow-y-auto"
            >
              {/* Menu Header */}
              <div className="flex items-center justify-between p-4 md:p-6 border-b border-rose/10">
                <span className="text-cream font-bold text-base md:text-lg" style={{ fontFamily: 'var(--font-cinzel)' }}>
                  Menu
                </span>
                <motion.button
                  whileTap={{ scale: 0.9 }}
                ...
                >
                  <span className="material-symbols-outlined text-rose text-xl md:text-2xl">close</span>
                </motion.button>
              </div>
