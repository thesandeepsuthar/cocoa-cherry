...
const features = [
  {
    ...
    description:
      "Fully licensed and FSSAI certified home bakery in Ahmedabad. We follow strict hygiene and food safety protocols for your peace of mind.",
  ...
  },
  {
    ...
    description:
      "We use imported Callebaut Belgian chocolate, fresh seasonal fruits, real butter, and premium ingredients in every cake.",
  ...
  },
  {
    ...
    description:
      "Bespoke designer cakes, photo cakes, themed cakes, and fondant artistry tailored to your vision and celebration.",
  ...
  },
  {
    ...
    description:
      "Fast and safe cake delivery across Ahmedabad via Porter. Same day delivery before 2PM, midnight delivery available.",
    ...
    >
      <div className="card-noir p-6 md:p-8 h-full relative overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
          <div
            className={`absolute top-0 left-0 w-full h-full bg-gradient-to-br ${feature.gradient} opacity-5`}
          />
        </div>

        {/* Corner accent */}
        <div
          className={`absolute top-0 right-0 w-20 h-20 bg-gradient-to-br ${feature.gradient} opacity-10 blur-2xl group-hover:opacity-20 transition-opacity`}
        />
        ...
        >
          ...
          {/* Icon glow */}
          <div
            className={`absolute inset-0 rounded-2xl bg-gradient-to-br ${feature.gradient} blur-xl opacity-50 -z-10`}
          />
        </motion.div>
        ...
        <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center mb-12 sm:mb-16 md:mb-20">
          ...
          >
            ...
            <p className="text-cream-muted text-sm sm:text-base md:text-lg leading-relaxed max-w-lg mx-auto lg:mx-0 mb-6 sm:mb-8">
              We don&apos;t just bake cakes; we craft edible centerpieces for
              your most cherished moments. Using only the finest ingredients,
              every slice is a testament to quality and passion.
            </p>
            ...
            {[
              ...
              >
                <div className="flex items-center justify-center gap-2 mb-1 sm:mb-2">
                  <span className="material-symbols-outlined text-rose/60 text-base sm:text-xl">
                    {stat.icon}
                  </span>
                </div>
                <p
                  className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold gradient-text mb-0.5 sm:mb-1"
                  style={{ fontFamily: "var(--font-cinzel)" }}
                >
                  {stat.number}
                </p>
          ...
          <div className="inline-flex flex-col sm:flex-row items-center gap-2 sm:gap-4 px-4 sm:px-6 py-3 sm:py-4 rounded-xl sm:rounded-2xl bg-noir-light border border-rose/10">
            <div className="flex items-center gap-0.5 sm:gap-1 text-gold">
              {[1, 2, 3, 4, 5].map((i) => (
                <span
                  key={i}
                  className="material-symbols-outlined text-base sm:text-lg filled"
                >
                  star
                </span>
              ))}
            ...
            <p className="text-cream-muted text-xs sm:text-sm">
              Rated <span className="text-cream font-bold">5.0</span> by our
              customers
            </p>
          </div>
        </motion.div>
