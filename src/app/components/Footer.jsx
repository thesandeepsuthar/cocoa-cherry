        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
          ...
          >
            ...
            <Link href="#" className="inline-flex items-center gap-3 mb-6 group">
              ...
              >
                <div className="absolute inset-0 bg-rose/20 rounded-full blur-xl 
                             group-hover:bg-rose/40 transition-colors" />
                <Image
                  src="/logo.svg"
            ...
            <p className="text-cream-muted text-sm leading-relaxed max-w-sm mb-6">
              ...
              memories. FSSAI Certified home bakery in Ahmedabad.
            </p>
            ...
            <div className="flex items-center gap-3">
              ...
              <motion.a
                ...
                whileHover={{ scale: 1.1, y: -2 }}
                whileTap={{ scale: 0.95 }}
                className="w-11 h-11 rounded-xl bg-[#25D366] flex items-center justify-center 
              ...
              <motion.a
                ...
                whileHover={{ scale: 1.1, y: -2 }}
                whileTap={{ scale: 0.95 }}
                className="w-11 h-11 rounded-xl bg-rose/20 border border-rose/30 
                         flex items-center justify-center text-rose 
                         hover:bg-rose hover:text-noir transition-all"
              >
          ...
          >
            <h3 className="text-cream font-bold mb-5" style={{ fontFamily: 'var(--font-cinzel)' }}>
              Quick Links
            </h3>
            <ul className="space-y-3">
              {quickLinks.map((link, index) => (
                ...
                >
                  <Link
                    href={link.href}
                    className="text-cream-muted hover:text-rose transition-colors 
                             inline-flex items-center gap-2 text-sm group"
                  >
                    <span className="w-1 h-1 rounded-full bg-rose/50 
                                   group-hover:bg-rose transition-colors" />
                    {link.label}
                  </Link>
                </motion.li>
              ))}
              ...
              {contactInfo.map((item, index) => (
                <motion.li key={index} whileHover={{ x: 5 }}>
                  <a 
                    ...
                    className="flex items-start gap-3 text-cream-muted hover:text-cream 
                             transition-colors group"
                  >
                    <span className="material-symbols-outlined text-rose text-lg mt-0.5 
