...
Sent from Cocoa&Cherry Website`;
  ...
  const getInputClass = (fieldName) => {
    const base = "w-full bg-noir-light border rounded-lg sm:rounded-xl px-3 sm:px-4 py-2.5 sm:py-3 text-sm sm:text-base text-cream placeholder-cream-muted/50 transition-all duration-300";
        ...
        <div className="relative p-4 sm:p-6 border-b border-rose/10">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3 sm:gap-4">
              ...
              >
                <span className="material-symbols-outlined text-noir text-xl sm:text-2xl">cake</span>
              </motion.div>
              <div>
                <h3 className="text-lg sm:text-xl font-bold text-cream" style={{ fontFamily: 'var(--font-cinzel)' }}>
                  Order Your Cake
                </h3>
                <p className="text-cream-muted text-xs sm:text-sm">We&apos;ll connect on WhatsApp</p>
              </div>
            </div>
            <motion.button
            ...
            >
              ...
              {isSubmitting ? (
                <>
                  ...
                  <span className="text-sm sm:text-base">Opening WhatsApp...</span>
                </>
              ) : (
                <>
