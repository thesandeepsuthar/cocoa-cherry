        ...
        <div className="relative p-4 sm:p-6 overflow-y-auto max-h-[calc(90vh-120px)] sm:max-h-[calc(85vh-140px)]">
          <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4">
                    ...
                    >
                      {menuItems.length === 0 ? (
                        ...
                        <div className="p-2">
                          ...
                          {menuItems.filter(
                            (item) =>
                              !selectedCakes.some((c) => c.name === item.name),
                          ).length === 0 && (
                            <div className="p-4 text-center text-cream/50 text-sm">
            ...
            <motion.button
              ...
              whileHover={{
                scale: isSubmitting || selectedCakes.length === 0 ? 1 : 1.02,
              }}
              whileTap={{
                scale: isSubmitting || selectedCakes.length === 0 ? 1 : 0.98,
              }}
                    ...
                    >
                      <Image
                        ...
                        alt={
                          heroImage.alt ||
                          heroImage.title ||
                          "Premium custom cake from Cocoa&Cherry - FSSAI Certified Home Bakery Ahmedabad"
                        }
                        fill
                        priority
                        fetchPriority="high"
