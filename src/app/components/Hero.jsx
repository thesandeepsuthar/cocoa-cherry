        ...
        <div className="relative p-6 overflow-y-auto max-h-[calc(90vh-140px)] sm:max-h-[calc(85vh-140px)]">
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <motion.button
              ...
              className={`relative w-full py-3 md:py-4 rounded-xl font-bold text-sm md:text-base flex items-center justify-center gap-2 md:gap-3 overflow-hidden ${isSubmitting ? 'bg-cream-muted/30 cursor-not-allowed' : 'bg-[#25D366] hover:bg-[#20BD5A]'} text-white shadow-lg transition-all`}
            >
              {!isSubmitting && (
