        ...
        <div className="relative rounded-3xl overflow-hidden">
          ...
          <div className="relative glass-strong border border-rose/20 p-6 sm:p-8 md:p-12">
            ...
            <div className="text-center pt-8 sm:pt-4">
              ...
              >
                Celebrate your special moments with our handcrafted cakes. Order
                now and make your celebration unforgettable!
              </motion.p>
              ...
              >
                ...
                <div className="flex justify-center gap-2 sm:gap-4">
                  ...
                  <div className="text-rose text-2xl self-center animate-pulse">
                    :
                  </div>
                  ...
                  <div className="text-rose text-2xl self-center animate-pulse hidden sm:block">
                    :
                  </div>
