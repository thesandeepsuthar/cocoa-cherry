    ...
    >
      <div className={`card-noir overflow-hidden transition-all duration-300 ${isOpen ? 'border-rose/30' : ''}`}>
        ...
        >
          ...
          {/* Question */}
          <span className="flex-1 text-cream font-medium text-xs sm:text-sm md:text-base pr-2 sm:pr-4 leading-snug">
            {faq.question}
          </span>
            ...
            >
              <div className="px-4 sm:px-5 md:px-6 pb-4 sm:pb-5 md:pb-6 pt-0">
                <div className="pl-0 sm:pl-14 md:pl-16 border-l-2 border-rose/20 ml-5 sm:ml-6">
                  <p className="text-cream-muted text-xs sm:text-sm md:text-base leading-relaxed pl-3 sm:pl-4">
                    {faq.answer}
                  </p>
                </div>
              </div>
