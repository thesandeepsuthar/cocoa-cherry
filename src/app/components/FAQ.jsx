  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-4xl mx-auto px-4 md:px-8">
        ...
        >
          <div className="inline-flex flex-col sm:flex-row items-center gap-3 md:gap-4 p-4 md:p-6 rounded-2xl bg-noir-light border border-rose/10">
            <div className="w-12 h-12 md:w-14 md:h-14 rounded-full bg-gradient-to-br from-rose to-rose-dark flex items-center justify-center">
              <span className="material-symbols-outlined text-white text-xl md:text-2xl">support_agent</span>
            </div>
            <div className="text-center sm:text-left">
              <p className="text-cream font-bold text-sm md:text-base mb-0.5 md:mb-1">Still have questions?</p>
              <p className="text-cream-muted text-xs md:text-sm">We&apos;re here to help! Reach out anytime.</p>
            </div>
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="flex items-center gap-2 px-4 py-2.5 md:px-6 md:py-3 rounded-full bg-[#25D366] text-white font-bold text-sm md:text-base shadow-lg shadow-[#25D366]/30"
            >
