  ...
  "@graph": [
    {
      ...
      description:
        "Terms and conditions for ordering custom cakes from Cocoa&Cherry. Learn about our delivery policy, cancellation policy, and payment terms.",
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 md:px-8 text-center">
          ...
          >
            ...
            <div className="flex items-center justify-center gap-2 mt-4 sm:mt-6 text-cream-muted text-xs sm:text-sm px-2">
              <span className="material-symbols-outlined text-rose text-base sm:text-lg">
                calendar_today
              </span>
              <span>
                Last updated:{" "}
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 md:px-8">
          ...
          >
            <div className="flex items-start gap-3 sm:gap-4">
              <div
                className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-gradient-to-br from-rose to-rose-dark 
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="text-cream-muted leading-relaxed text-sm sm:text-base">
                  ...
                  for the use of our website and services. Please read these
                  terms carefully before placing an order or using our services.
                </p>
              </div>
            </div>
          </motion.div>
            ...
            {sections.map((section, index) => (
              ...
              >
                <div className="p-4 sm:p-6 md:p-8">
                  <div className="flex items-start gap-3 sm:gap-4">
                    <div
                      className="w-9 h-9 sm:w-10 sm:h-10 rounded-xl bg-rose/10 border border-rose/20 
                                  flex items-center justify-center flex-shrink-0
                    ...
                    <div className="flex-1 min-w-0">
                      <h2
                        className="text-base sm:text-lg md:text-xl font-bold text-cream mb-2 sm:mb-3"
                        style={{ fontFamily: "var(--font-cinzel)" }}
                      >
                        {section.title}
                      </h2>
          ...
          >
            <div className="card-glass p-6 sm:p-8 md:p-10">
              <div
                className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-full bg-gradient-to-br from-rose to-rose-dark 
              ...
              <p className="text-cream-muted mb-4 sm:mb-6 max-w-lg mx-auto text-sm sm:text-base px-2">
                By placing an order with Cocoa&Cherry, you acknowledge that you
