...
const contactPageSchema = {
  ...
  "@graph": [
    ...
    },
    {
      ...
      description:
        "Get in touch with Cocoa&Cherry for custom cake orders in Ahmedabad. Call +91 97127 52469 or WhatsApp us for instant service.",
      url: `${siteUrl}/contact`,
      mainEntity: {
        "@type": "ContactPoint",
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            >
              ...
              <p className="text-base sm:text-lg md:text-xl text-cream-muted px-2">
                We'd love to hear from you. Let's create something sweet
                together!
              </p>
            </motion.div>
          </div>
            ...
            <div className="max-w-6xl mx-auto">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 lg:gap-12">
                ...
                >
                    ...
                    <div className="space-y-4 sm:space-y-6">
                      ...
                      >
                        ...
                        <div className="min-w-0 flex-1">
                          <h3 className="text-cream font-bold mb-1 text-sm sm:text-base">
                            Phone
                          </h3>
                  ...
                  {/* Quick Actions */}
                  <div className="card-noir rounded-2xl p-5 sm:p-6 md:p-8">
                    <h3 className="text-lg sm:text-xl font-bold text-cream mb-3 sm:mb-4">
                      Quick Actions
                    </h3>
                    <div className="space-y-2 sm:space-y-3">
                      ...
                      >
                        <span className="material-symbols-outlined text-green-400 text-lg sm:text-xl">
                          shopping_cart
                        </span>
                        <span className="text-cream group-hover:text-green-400 transition-colors text-sm sm:text-base">
                          Order Now
                        </span>
                      </a>
                      <a
                      ...
                      >
                        ...
                        <span className="text-cream group-hover:text-rose transition-colors text-sm sm:text-base">
                          Call Us
                        </span>
                      </a>
                    </div>
                  ...
                  {submitted ? (
                    ...
                    >
                      <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-green-500/20 flex items-center justify-center mx-auto mb-3 sm:mb-4">
                        <span className="material-symbols-outlined text-3xl sm:text-4xl text-green-400">
                          check_circle
                        </span>
                      </div>
                      <h3 className="text-lg sm:text-xl font-bold text-cream mb-2">
                        Message Sent!
                      </h3>
                    ...
                    >
                      <div>
                        <label className="block text-cream font-medium mb-1.5 sm:mb-2 text-sm sm:text-base">
                          Name *
                        </label>
                        <input
                          type="text"
