...
export const metadata = {
  ...
  description:
    "Order premium custom cakes in Ahmedabad. Birthday, wedding & designer cakes with Belgian chocolate. FSSAI certified. Same day delivery! Call 97127-52469",
  ...
  openGraph: {
    ...
    title:
      "Custom Cakes in Ahmedabad | Cocoa&Cherry Home Bakery ⭐ FSSAI Certified",
    description:
...
const jsonLd = {
  ...
  "@graph": [
    // 1. ORGANIZATION SCHEMA
    {
      ...
      sameAs: ["https://www.instagram.com/cocoa_cherry_"],
    },
    ...
    // 2. LOCAL BUSINESS / BAKERY SCHEMA (More specific)
    {
      ...
      address: {
        "@type": "PostalAddress",
        streetAddress:
          "9/A, Dholeshwar Mahadev Rd, Ganesh Park Society, Rajeswari Society",
      ...
      review: [
        {
          ...
          reviewBody:
            "Amazing cakes! The chocolate truffle cake was absolutely delicious. Highly recommend Cocoa&Cherry for all celebrations.",
          reviewRating: {
            "@type": "Rating",
            ratingValue: "5",
            bestRating: "5",
        ...
        hasMenuSection: [
          {
            ...
            name: "Birthday Cakes",
            description:
              "Custom birthday cakes with designer themes and photo printing",
            hasMenuItem: [
              {
                "@type": "MenuItem",
                name: "Chocolate Truffle Cake",
                description:
                  "Rich chocolate truffle cake made with Belgian chocolate ganache",
                offers: {
                  "@type": "Offer",
                  price: "850",
                  priceCurrency: "INR",
          ...
          hasPart: [
            {
              ...
              url: `${siteUrl}/about`,
              description:
                "Learn about Cocoa&Cherry, our story, founder Jhanvi Thakar, and FSSAI certification",
            },
            {
              "@type": "SiteNavigationElement",
              name: "Menu",
              url: `${siteUrl}/menu`,
              description:
                "Browse our complete menu of premium custom cakes, brownies, cheesecakes, and desserts",
            },
            {
              "@type": "SiteNavigationElement",
              name: "Services",
              ...
              description:
                "Custom cake services including birthday cakes, wedding cakes, same-day delivery",
            },
            {
              "@type": "SiteNavigationElement",
              name: "Gallery",
              url: `${siteUrl}/gallery`,
              description:
                "View our portfolio of custom cakes, wedding cakes, and celebration cakes",
            },
            {
              "@type": "SiteNavigationElement",
              name: "Events",
              url: `${siteUrl}/events`,
              description:
                "Book us for your events - birthdays, weddings, anniversaries, and celebrations",
            },
            {
              "@type": "SiteNavigationElement",
              name: "Reviews",
              url: `${siteUrl}/reviews`,
              description:
                "Read customer reviews and testimonials for Cocoa&Cherry cakes",
            },
            {
              "@type": "SiteNavigationElement",
              name: "Contact",
              url: `${siteUrl}/contact`,
              description:
                "Get in touch with Cocoa&Cherry. Call +91 97127 52469 or WhatsApp us",
            },
          ],
        },
      ],
    ...
    // 4. WEBPAGE SCHEMA
    {
      ...
      description:
        "Order premium custom cakes in Ahmedabad. Birthday, wedding, anniversary cakes with Belgian chocolate. Same day delivery available.",
      breadcrumb: {
      ...
      itemListElement: [
        {
          ...
          url: siteUrl,
          description:
            "Custom Cakes Ahmedabad | Cocoa&Cherry FSSAI Certified Home Bakery",
        },
        {
          "@type": "ListItem",
          position: 2,
    ...
    // 7. PRODUCT SCHEMA (Featured Product)
    {
      ...
      description:
        "Rich chocolate truffle cake made with premium Belgian Callebaut chocolate and layers of chocolate ganache. Perfect for birthdays, anniversaries, and celebrations in Ahmedabad.",
      brand: {
        "@type": "Brand",
        name: "Cocoa&Cherry",
      },
      ...
      itemListElement: [
        {
          ...
          itemOffered: {
            ...
            description:
              "Personalized birthday cakes with custom designs, photo printing, and themed decorations",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Elegant multi-tier wedding cakes with premium fondant and buttercream designs",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Express cake delivery within Ahmedabad for last-minute celebrations and surprises",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Bulk cake orders for corporate events, office celebrations, and business meetings in Ahmedabad",
          },
        },
        {
          "@type": "Offer",
          itemOffered: {
            ...
            description:
              "Surprise midnight cake delivery for birthdays and special occasions in Ahmedabad",
          },
        },
      ],
    },
  ...
  return (
    <html lang="en-IN" className="dark">
      <head>
        ...
        <meta
          name="copyright"
          content={`© ${new Date().getFullYear()} Cocoa&Cherry. All rights reserved.`}
        />
